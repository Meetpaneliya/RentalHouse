...
const FilterSection = () => {
  ...
  // Filter listings based on the filters state
    ...
    useEffect(() => {
      const filterListings = () => {
        ...
        : true; // Include all if no propertyType is selected
  ...
  return (
    <div>
      <div className="w-full mx-auto p-4 bg-white shadow-md rounded-lg flex flex-wrap gap-4 items-center justify-center overflow-visible relative">
        {/* Price Filter */}
        ...
        <div className="relative" ref={resetFilterRef}>
          <button
            ...
            className="px-4 py-2 bg-red-600 text-white rounded-lg shadow cursor-pointer hover:bg-red-700"
          >
            Reset
          </button>
          {showResetFilter && (
      ...
      {/* Render Listings component and pass filteredListings as props */}
      <div>
