...
const Rooms = () => {
  ...
  const description = "Don't miss out on this smart and efficient four-bedroom, one-bathroom shared apartment in a prime Manhattan neighborhood. This 713 sq. ft. unit on the fourth floor features central heating, recessed lighting, high ceilings, and an all-in-one washer-dryer combo. Cozy bedrooms offer closets and a comfortable space to unwind. The modern kitchen includes stainless steel appliances and ample storage. Conveniently located near public transport, shopping, and dining, this apartment is perfect for city living."
    ...
    <div>
      ...
      <div className="max-w-7xl flex items-center justify-between mx-auto mt-10 mb-5">
        <div className=" text-blue-900">
          <h1 className='text-3xl font-bold '>Upper West Side - #363-A</h1>
            ...
            <div className="flex flex-col gap-5">
                  ...
                  <div>
                        <div className='max-w-7xl mx-auto mt-5 space-y-5'>
                            ...
                            <h2 className='flex text-xl gap-2 font-semibold'><span><VscHome size={30} /></span>83 ft | 4th Floor | 4 Beds | 1 Bath</h2>
                            <h2 className='flex text-xl gap-2 items-center font-semibold'><span><SlCalender size={20}/></span>Available form 02/27/25</h2>
                        </div>
                  ...
                  <div>
                      ...
                      <div className='flex flex-wrap gap-3 mt-4'>
                        <div className='bg-gray-800 text-white px-4 py-1 rounded-full flex items-center gap-1'><span><GrElevator /></span>Elevator</div>
                        <div className='bg-gray-800 text-white px-4 py-2 rounded-full flex items-center gap-1'><span><FaWifi /></span>WiFi</div>
                        <div className='bg-gray-800 text-white px-4 py-1 rounded-full flex items-center gap-1'><span><MdTv /></span>TV</div>
                        <div className='bg-gray-800 text-white px-4 py-1 rounded-full flex items-center gap-1'><span><TbAirConditioning /></span>AC</div>
                        <div className='bg-gray-800 text-white px-4 py-1 rounded-full flex items-center gap-1'><span><GiHeatHaze /></span>Geyser</div>
                      </div> 
                  </div>
